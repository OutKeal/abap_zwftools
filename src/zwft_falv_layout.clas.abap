class ZWFT_FALV_layout definition
  public
  create public

  global friends ZWFT_FALV .
  ...
  public section.
    ...
    methods constructor
      importing
        !io_falv type ref to ZWFT_FALV .
    methods set_zebra
      importing
                value(iv_value) type lvc_zebra
      returning value(r_layout) type ref to ZWFT_FALV_layout.
    methods set_edit
      importing
  ...
  private section.
    ...
    data: falv               type ref to ZWFT_FALV,
...
class ZWFT_FALV_layout implementation.
