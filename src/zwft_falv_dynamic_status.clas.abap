class ZWFT_FALV_dynamic_status definition
  public
  final
  create public .
  ...
  public section.
    ...
    methods add_button
      ...
      RETURNING
        VALUE(r_status) TYPE REF TO ZWFT_FALV_dynamic_status
      exceptions
...
class ZWFT_FALV_dynamic_status implementation.
  ...
  method constructor.
    excluded_buttons = value #( ( b_01 ) ( b_02 ) ( b_03 ) ( b_04 ) ( b_05 ) ( b_06 ) ( b_07 ) ( b_08 ) ( b_09 )
                                ...
                                ( ZWFT_FALV=>mc_fc_data_save ) ( ZWFT_FALV=>fc_first_page )
                                ( ZWFT_FALV=>fc_last_page ) ( ZWFT_FALV=>fc_next_page ) ( ZWFT_FALV=>fc_previous_page ) ( ZWFT_FALV=>fc_print ) ).
  endmethod.
  ...
  method show_gui_status.
    if sy-dynnr eq ZWFT_FALV=>c_screen_full and fully_dynamic eq abap_true.
      set pf-status 'DYNAMIC_STATUS' of program ZWFT_FALV=>c_fscr_repid excluding excluded_buttons.
    elseif sy-dynnr eq ZWFT_FALV=>c_screen_full.
      set pf-status 'DYNAMIC_STATUS_PART' of program ZWFT_FALV=>c_fscr_repid excluding excluded_buttons.
    else.
      set pf-status 'STATUS_0200' of program ZWFT_FALV=>c_fscr_repid excluding excluded_buttons.
    endif.
  endmethod.


  method show_title.
    set titlebar 'TITLE' of program ZWFT_FALV=>c_fscr_repid with iv_text1 iv_text2 iv_text3 iv_text4 iv_text5.
  endmethod.
endclass.
